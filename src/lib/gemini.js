...
Return a strict JSON object with this exact structure:
{
  ...
  "schedule": [
    { "week": "Weeks 1-4", "action": "Foundation phase - establish baseline habits", "dosage": "Focus: sleep hygiene + hydration" },
    { "week": "Weeks 5-8", "action": "Build phase - increase intensity", "dosage": "Focus: nutrition optimization + exercise" },
    { "week": "Weeks 9-12", "action": "Optimization phase - fine-tune routine", "dosage": "Focus: stress management + recovery" }
  ],
  ...
  if (!jsonMatch) throw new Error('Could not generate plan');
