  ...
  return (
    <div className="page" style={{ paddingBottom: 40 }}>
      ...
      <div style={{ fontSize: '0.85rem', color: '#666', lineHeight: 1.8 }}>
        ...
        <h3 style={{ color: '#1a1a1a', marginTop: 20, marginBottom: 8 }}>2. Third-Party AI Services &amp; Data Sharing</h3>
        ...
        <h3 style={{ color: '#1a1a1a', marginTop: 20, marginBottom: 8 }}>3. How We Use Your Information</h3>
        ...
        <h3 style={{ color: '#1a1a1a', marginTop: 20, marginBottom: 8 }}>4. Data Storage &amp; Security</h3>
        ...
        <h3 style={{ color: '#1a1a1a', marginTop: 20, marginBottom: 8 }}>5. Apple Health (HealthKit)</h3>
        ...
        <h3 style={{ color: '#1a1a1a', marginTop: 20, marginBottom: 8 }}>6. Health Information Disclaimer</h3>
        ...
        <h3 style={{ color: '#1a1a1a', marginTop: 20, marginBottom: 8 }}>7. Third-Party Services</h3>
        <ul style={{ paddingLeft: 20, marginTop: 8 }}>
        ...
        <h3 style={{ color: '#1a1a1a', marginTop: 20, marginBottom: 8 }}>8. Your Rights</h3>
        ...
        <h3 style={{ color: '#1a1a1a', marginTop: 20, marginBottom: 8 }}>9. Children's Privacy</h3>
        ...
        <h3 style={{ color: '#1a1a1a', marginTop: 20, marginBottom: 8 }}>10. Changes to This Policy</h3>
        ...
        <h3 style={{ color: '#1a1a1a', marginTop: 20, marginBottom: 8 }}>11. Contact</h3>
