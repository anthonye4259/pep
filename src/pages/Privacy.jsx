  ...
  return (
    <div className="page" style={{ paddingBottom: 40 }}>
      ...
      <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: 1.8 }}>
        <p><strong>Effective Date:</strong> July 06, 2026</p>
        ...
        <p style={{ marginBottom: 8 }}><strong>PeptidAI uses external AI services to generate personalized wellness plans only after you provide explicit consent.</strong> Before any data is sent, the App discloses the recipient, data categories, and purpose.</p>
        <ul style={{ paddingLeft: 20, marginTop: 8 }}>
          ...
          <li><strong>Who Receives It:</strong> This data is transmitted to <strong>Google's Gemini API</strong>, a third-party AI service operated by Google LLC. If Gemini is unavailable, backup AI providers Groq, Inc. or Cerebras Systems Inc. may process the same data for the same purpose.</li>
          ...
          <li><strong>Provider Policies:</strong> External AI providers process data according to their own privacy policies and service terms.</li>
        </ul>
        <p style={{ marginTop: 8 }}><strong>Your Consent:</strong> Before any data is sent to an external AI service, the App will present you with a data disclosure and request your explicit consent. You may decline, in which case no data will be sent to external AI services. You may revoke consent from Settings.</p>
        ...
        <ul style={{ paddingLeft: 20, marginTop: 8 }}>
          <li>Generate AI-powered personalized wellness plans via external AI services after consent</li>
        ...
        <p>Your data is stored securely using Google Firebase (Firestore) with encryption at rest and in transit. AI queries are processed in real time by external AI providers to generate your wellness plan and are not sold by PeptidAI.</p>
        ...
        <ul style={{ paddingLeft: 20, marginTop: 8 }}>
          <li><strong>Google Gemini API</strong> — AI-powered wellness plan generation after consent (data shared as described in Section 2)</li>
          <li><strong>Groq, Inc.</strong> — backup AI-powered wellness plan generation after consent</li>
          <li><strong>Cerebras Systems Inc.</strong> — backup AI-powered wellness plan generation after consent</li>
        ...
        <p>You may request deletion of your account and all associated data at any time through the Settings page in the App, or by contacting support@peptidai.com. Data will be permanently deleted within 30 days of request. You may also clear your journal history, revoke AI data sharing consent in Settings, and revoke Apple Health access at any time in iOS Settings.</p>
