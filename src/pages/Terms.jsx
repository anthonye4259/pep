  ...
  return (
    <div className="page" style={{ paddingBottom: 40 }}>
      ...
      <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: 1.8 }}>
        ...
        <h3 style={{ color: 'var(--text)', marginTop: 20, marginBottom: 8 }}>1. Acceptance of Terms</h3>
        <p>By downloading, installing, or using PeptidAI ("the App"), you agree to be bound by these Terms of Service.</p>

        <h3 style={{ color: 'var(--text)', marginTop: 20, marginBottom: 8 }}>2. Nature of the Service</h3>
        ...
        <h3 style={{ color: 'var(--text)', marginTop: 20, marginBottom: 8 }}>3. User Responsibility</h3>
        ...
        <h3 style={{ color: 'var(--text)', marginTop: 20, marginBottom: 8 }}>4. Disclaimer of Warranties</h3>
        ...
        <h3 style={{ color: 'var(--text)', marginTop: 20, marginBottom: 8 }}>5. Limitation of Liability</h3>
        ...
        <h3 style={{ color: 'var(--text)', marginTop: 20, marginBottom: 8 }}>6. Subscriptions</h3>
        ...
        <h3 style={{ color: 'var(--text)', marginTop: 20, marginBottom: 8 }}>7. Modifications</h3>
        ...
        <h3 style={{ color: 'var(--text)', marginTop: 20, marginBottom: 8 }}>8. Contact</h3>
